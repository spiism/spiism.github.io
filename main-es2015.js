...
let AppComponent = class AppComponent {
    constructor(router, titleService) {
        ...
        this.router.events
            ...
            this.titleService.setTitle(snapshot.data.title || 'Angular Web Application');
        });
    }
};
